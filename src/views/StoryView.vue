...
import { init, goToSlide, slides } from "@/shuffle.js";

const SLIDES_LENGTH = 2;
...
export default {
  ...
  methods: {
    ...
    onCompleteModule(moduleNameInStore, module) {
      ...
      moduleElements.forEach((el) => {
        ...
        el.textContent = isUppercase
          ? translation[0].toUpperCase() + translation.slice(1) + punctuation
      ...
      if (store.allModulesCompleted()) {
        ...
        this.announceMessage =
          "All modules completed! You have unlocked all the words in the story.";
      } else {
        this.announceMessage =
          "A module has been completed. New words have been unlocked in the story.";
      }
    },
    ...
    resetAllModules() {
      ...
      this.announceMessage =
        "All modules have been reset. You are now back at the beginning.";
      this.clearAriaAnnouncements();
    },
    toggleWord(event) {
      ...
      if (target.matches("button.translated")) {
        ...
        const punctuation = match ? match[2] : "";
        target.textContent = isUppercase
          ? translated[0].toUpperCase() + translated.slice(1) + punctuation
    ...
    goNext() {
      if (this.slidesIndex >= this.numberSlides - 1) return;
      this.slidesIndex++;
      this.$nextTick(() => {
  ...
  <div class="container story">
    <section class="intro">
      ...
      <p class="project-description">
        An Itsẹkiri folktale that unveils itself to the reader as they learn words from
        the language. <u>Click on "bubble" to get started learning.</u>
      </p>
    ...
    <div class="big-circle">
      <div class="circle" @click="toggleWord">
        ...
        <main :aria-hidden="isModuleActive ? 'true' : 'false'" id="story">
          <div v-if="slidesIndex === 0" id="slide1">
            <p data-index="1">
              Mai retin mi. Ọ́má ghaan<sup><a class="footnote-link" id="ref1" href="#fn1">[1]</a></sup>
              mi. Aghan retin mi di èmi<sup><a class="footnote-link" id="ref2" href="#fn2">[2]</a></sup>
              gin gbẹ aghan.
            </p>
            <p data-index="2">
              Ọnobirẹn ọkan ti a kpe Ọlikpẹrẹbu. Éè nẹ ajá Itsẹkiri kì ajá Itsẹkiri<sup><a class="footnote-link"
                  id="ref3" href="#fn3">[3]</a></sup>
              tee wà gbaa bẹ ọnobirẹn wee, gin aghan fẹ gba tse obirẹn<sup><a class="footnote-link" id="ref4"
                  href="#fn4">[4]</a></sup>, ain éè jẹ. Èyí ma bà ain éè jẹ. Ubo kì ubo ni ẹye wee dede, ajá Itsẹkiri
              kì ajá Itsẹkiri dede wà<sup><a class="footnote-link" id="ref5" href="#fn5">[5]</a></sup>
              gbaa<sup><a class="footnote-link" id="ref6" href="#fn6">[6]</a></sup> ri
              ọnobirẹn wee ain éè jẹ. Nikọ rẹ tse ti wo gba gin éè jẹ? Ain éè jẹ, ain éè
              fẹ aghan kì aghan.
            </p>
            <p data-index="3">
              Ọjọ ọkan ẹgualẹ ọkan ni inọ oko ti a kpe Ọribiti. O<sup><a class="footnote-link" id="ref7"
                  href="#fn7">[7]</a></sup>
              gbo. Ain ọnobirẹn bokọ ni ẹye wee, ọnobirẹn ti a bẹ ti o gin éè jẹ? Ain mo
              wà tó uwẹrẹ. Ọribiti wee gba rè dá ara ro. O gba tó ubo ti ẹsẹn gha, o bí '
              ẹsẹn. O gba tó ubo ti ẹwọ gha, o bí ' ẹwọ. O gba tó ubo ti origho gha, o bí
              ' origho. O gba tó ubo ti ẹju gha, o bí ' ẹju. O ni ' ẹwu. O ró ' aṣọ. O ni
              ' isabatu. O bí ' ọkpa. O bí ' ẹkoro. O rè, o gin o wà bà ọnobirẹn
              Ọlikpẹrẹbu wee.
            </p>

            <p data-index="4">
              Ọnobirẹn wee de gẹrẹ sẹngua. Ọnobirẹn wee Ọlikpẹrẹbu ghele olikperebu<sup><a class="footnote-link"
                  id="ref8" href="#fn8">[8]</a></sup>. Ọnobirẹn Ọlikpẹrẹbu gbaa ri, o sá gbaa buru, o dinma ro. O kpe
              iyẹ ro
              biri ọwa ro, o gin èyí ọkọ ti ' èmi fẹ dọ.
            </p>
            <p data-index="5">
              Iyọ! A gin " èyí ọnọkẹrẹn ti wo fẹ dọ? " O gin " èyí ọnọkẹrẹn ti ' èmi fẹ dọ
              oo. " Wo desin tsi? Ain èyí ọnọkẹrẹn ti o fẹ dọ. A gin osan oo. Ẹgualẹ wee
              gba wọ ' ulí, a kin, a mu___gbẹ<sup><a class="footnote-link" id="ref9" href="#fn9">[9]</a></sup>
              ọjẹ. O gin éè te jẹrun, gin di ' a gbe ọjẹ wee, di ' a gbe-tsi abẹtẹ wee. A
              gbe-tsi abẹtẹ wee. O gba tsọn èyí tsọn èyí. O wọ inọ abẹtẹ wee, o dá ara ro
              gba dá ẹgualẹ wee Ọribiti wee. O da ọjẹ wee tsi alẹ wee, o la, o la, o la jẹ̀
              kuro. O dá tsitsi irẹye.
            </p>
            ...
            <p data-index="7">
              ...
              ọl- ẹju gha, o mu___gbẹ ẹju ọl- ẹju. Ara ro dede o dá, ẹwu biri aṣọ o
              kó-tsi. O dá ẹgualẹ.
            </p>

            <p data-index="8">
              Ẹru-ka-ba Ọlikpẹrẹbu. Ẹgualẹ wee kpe, ain Ọlikpẹrẹbu wo ' éè rè ubo kì ubo,
              ain owún biri uwọ oo. Wo ' éè rè ubo kì ubo.
            </p>
            <p data-index="9">
              Ọlikpẹrẹbu, o sọn. O gin " èyí ẹye ro re oo. " Ọrọnrọn irẹye wà gbaa bẹ. O
              gin éè jẹ. Éè forijẹ. Eh! O jẹ gin ọribiti o wà dọ. Ẹgualẹ wee ka din ẹsẹn
              ro gba egin. O kani uwẹrẹ.
            </p>
            <p data-index="10">
            ...
            <div class="footnotes" v-if="allModulesCompleted">
              ...
              <ol>
                ...
                <li id="fn2">
                  Whenever two vowels meet, the first vowel is ignored and the words join
                  and are said together. `di èmi` becomes `dèmi`, `ti a kpe` becomes `ta
                  kpe.` This pattern was not adhered to on this site because I wanted to
                  preserve the full words for learning purposes.
                  <a class="footnote-link" href="#ref2" title="Return to text">&#8617;</a>
                </li>
                <li id="fn3">
                  When `kì` is used as in `ajá Itsẹkiri kì ajá Itsẹkiri`, it turns the
                  meaning of the reduplication into 'any.' So `ajá Itsẹkiri kì ajá
                  Itsẹkiri` becomes 'any/every Itsẹkiri town.'
                  <a class="footnote-link" href="#ref3" title="Return to text">&#8617;</a>
                </li>
                <li id="fn4">
                  'obirẹn' and 'aya' both mean wife but 'obirẹn' is used as a
                  representation of the role, not to address a married woman.
                  <a class="footnote-link" href="#ref4" title="Return to text">&#8617;</a>
                </li>
                <li id="fn5">
                  Some words like `wà` have the same spelling, different meanings based on
                  context.
                  <a class="footnote-link" href="#ref5" title="Return to text">&#8617;</a>
                </li>
                <li id="fn6">
                  When you see or hear `gbaa` it means the preceding action is present
                  continuous.
                  <a class="footnote-link" href="#ref6" title="Return to text">&#8617;</a>
                </li>
                <li id="fn7">
                  Itsẹkiri does not have gendered pronouns. Meaning is gleaned through
                  context.
                  <a class="footnote-link" href="#ref7" title="Return to text">&#8617;</a>
                </li>
                <li id="fn8">
                  In this story, 'Ọlikpẹrẹbu' is the akpuja (nickname) of the main
                  character, it translates roughly to "a woman who has it all."
                  <a class="footnote-link" href="#ref8" title="Return to text">&#8617;</a>
                </li>
                <li id="fn9">
                  The word for 'give,' mu___gbẹ is meant to be broken up with the thing
                  being given in the middle when written correctly. e.g `mu ọjẹ gbẹ` or
                  `mu ẹsẹn gbẹ`
...
.word.stable {
  animation: stableAnchor var(--stable-dur, 1200ms) ease-in-out forwards;
}

@keyframes stableAnchor {
  0% {
    opacity: 1;
    color: var(--white);
  }
